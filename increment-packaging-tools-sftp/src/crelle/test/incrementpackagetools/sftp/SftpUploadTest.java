...
public class SftpUploadTest {
    ...
    public static void main(String[] args) throws Exception {
        SftpUploadTest uploadTest = new SftpUploadTest("ftp1", "123456", "192.168.74.3", 22);
//        uploadTest.uploadFile("/tmp/" + "readme-" + System.currentTimeMillis() + ".txt", "C:\\Users\\crelle\\Desktop\\sample\\readme.txt");
        uploadTest.downloadFile("/home/ftp1/yxskapp/sgpmss_ctrl/webapp/app/gcmanage/BTRANDetail.jsp", "E:\\ftpclient-test\\readme-" + System.currentTimeMillis() + ".txt");
    }
}