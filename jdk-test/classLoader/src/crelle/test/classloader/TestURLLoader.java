package crelle.test.classloader;
...
class LoaderFromDisk {
    ...
    LoaderFromDisk() throws MalformedURLException, ClassNotFoundException, IllegalAccessException, InstantiationException {
        ...
        Class aclass = urlClassLoader.loadClass("crelle.test.classloader.Person");
        crelle.test.classloader.Person obj = (Person)aclass.newInstance();
